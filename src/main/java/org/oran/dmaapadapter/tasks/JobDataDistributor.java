...
public abstract class JobDataDistributor {
    ...
    private boolean filterStartTime(PmReportFilter.FilterData filter, String fileName) {
    ...
    private boolean filterEndTime(PmReportFilter.FilterData filter, String fileName) {
        // A20000626.2315+0200-2330+0200_HTTPS-6-73.json
    ...
    private OffsetDateTime parseFileDate(String timeStr) {
